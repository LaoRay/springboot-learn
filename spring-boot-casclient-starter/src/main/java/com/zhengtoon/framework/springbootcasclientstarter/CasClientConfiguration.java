...
import com.zhengtoon.framework.springbootcasclientstarter.casconfig.CasClientConfigurationProperties;
...
public class CasClientConfiguration {
    ...
    @Autowired
    public CasClientConfiguration(CasClientConfigurationProperties configProps){
