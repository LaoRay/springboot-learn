...
import zhengtoon.framework.task.core.utils.HttpClientUtil;
...
public class JobTask implements Job{
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        TaskCase taskCase = (TaskCase)jobExecutionContext.getJobDetail().getJobDataMap().get(JobContextKeyEnum.JOB_CONTEXT_KEY.getKey());
