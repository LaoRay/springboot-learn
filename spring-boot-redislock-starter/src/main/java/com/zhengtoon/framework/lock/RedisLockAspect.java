...
import com.zhengtoon.framework.lock.annotation.RedisLock;
//import com.zhengtoon.framework.lock.annotation.RedisLockParam;
//import com.zhengtoon.framework.lock.annotation.RedisLockRequest;
...
public class RedisLockAspect {
    ...
    @Around(value = "@annotation(com.zhengtoon.framework.lock.annotation.RedisLock)")
    public Object around(ProceedingJoinPoint jp) throws Throwable {
        ...
        Object result = null;
        if (success) {
            log.debug("The lock is occupied!");
            try {
                result = jp.proceed();
            } finally {
            ...
            log.debug("The lock has been occupied");
        }
        return result;
    }
    ...
    private String getLockedKey(ProceedingJoinPoint jp, Method method) throws Throwable {
        ...
        */
        ...
        /*
         *  modify20180821，去掉了原本的逻辑,只通过redisLock的value参数作为redis的key
         */
        // 加上前后缀
        RedisLock redisLock = method.getAnnotation(RedisLock.class);
